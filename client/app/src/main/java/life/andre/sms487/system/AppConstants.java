...
public class AppConstants {
    ...
    public static final String NOTIFICATION_SETTING_ACTIVITY = "android.settings.ACTION_NOTIFICATION_LISTENER_SETTINGS";
    public static final int PERMISSIONS_REQUEST_ID = 487;
}
